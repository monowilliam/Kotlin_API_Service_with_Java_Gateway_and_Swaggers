...
group = "kotlin-concepts-service-api"
...
dependencies {
	...
	compile(group="javax.persistence", name="javax.persistence-api", version="2.2") //Nuevo
	compile(group= "org.springframework.data", name= "spring-data-commons", version= "2.4.0") //Nuevo
