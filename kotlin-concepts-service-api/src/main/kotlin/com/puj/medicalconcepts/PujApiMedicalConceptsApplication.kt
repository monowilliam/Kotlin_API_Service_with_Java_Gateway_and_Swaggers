package com.puj.medicalconcepts

import org.springframework.boot.autoconfigure.SpringBootApplication
import org.springframework.boot.runApplication

import com.puj.medicalconcepts.security.JWTAuthorizationFilter;
...
@EnableSwagger2
class PujApiMedicalConceptsApplication {
    companion object {
        @JvmStatic
        fun main(args: Array<String>) {
            runApplication<PujApiMedicalConceptsApplication>(*args)
        }
    }
    ...
    */
    ...
    fun amtApiDocket(): Docket {
        return Docket (DocumentationType.SWAGGER_2)
            ...
            .select().apis(RequestHandlerSelectors.basePackage("com.puj.medicalconcepts.controller"))
            .paths(regex("/.*"))
    ...
    fun defineApiMetaData(): ApiInfo {
        return ApiInfoBuilder()
                .title("MedicalConcepts PUJ API")
                .description("\"MedicalConcepts PUJ RESTful API\"")
